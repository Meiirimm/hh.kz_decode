...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const citiesData = [
      ...
      { name: 'Хор', countryId: countryRows[4].id },
      { name: 'Армавир', countryId: countryRows[4].id },
      { name: 'Арташат', countryId: countryRows[4].id },
      { name: 'Гавар', countryId: countryRows[4].id },
      { name: 'Аштарак', countryId: countryRows[4].id },
      ...
      { name: 'Саатлы', countryId: countryRows[5].id },
      { name: 'Нафталан', countryId: countryRows[5].id },
      { name: 'Габала', countryId: countryRows[5].id },
      { name: 'Шамкир', countryId: countryRows[5].id },
      // Города Грузии
      ...
      { name: 'Поти', countryId: countryRows[6].id },
      { name: 'Зугдиди', countryId: countryRows[6].id },
      { name: 'Телави', countryId: countryRows[6].id },
      { name: 'Кобулети', countryId: countryRows[6].id },
      // Города Молдавии
      ...
      { name: 'Унгены', countryId: countryRows[7].id },
      { name: 'Кагул', countryId: countryRows[7].id },
      { name: 'Орхей', countryId: countryRows[7].id },
      { name: 'Дубоссары', countryId: countryRows[7].id },
      { name: 'Каушаны', countryId: countryRows[7].id },
      { name: 'Страшены', countryId: countryRows[7].id },
      // Города Таджикистана
      ...
      { name: 'Исфара', countryId: countryRows[8].id },
      { name: 'Хорог', countryId: countryRows[8].id },
      { name: 'Вахдат', countryId: countryRows[8].id },
      { name: 'Нурек', countryId: countryRows[8].id },
      { name: 'Истаравшан', countryId: countryRows[8].id },
      { name: 'Джиргитал', countryId: countryRows[8].id },
      ...
      { name: 'Тебенди', countryId: countryRows[9].id },
      { name: 'Фарап', countryId: countryRows[9].id },
      { name: 'Атырау', countryId: countryRows[9].id },
      { name: 'Бейнеу', countryId: countryRows[9].id },
      // Города Узбекистана
      ...
      { name: 'Карши', countryId: countryRows[10].id },
      { name: 'Ургенч', countryId: countryRows[10].id },
      { name: 'Коканд', countryId: countryRows[10].id },
      { name: 'Гулистан', countryId: countryRows[10].id },
      // Города Кыргызстана
      ...
      { name: 'Кара-Балта', countryId: countryRows[11].id },
      { name: 'Баткен', countryId: countryRows[11].id },
      { name: 'Исфана', countryId: countryRows[11].id },
    ];
